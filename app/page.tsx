    ...
    <main className='min-h-[calc(100vh-100px)]'>
      <section className='py-16 md:py-20 lg:py-32 relative'>
        <div className='container relative mx-auto text-center'>
          ...
          <Text as="p" className='text-[15px] md:text-base lg:text-lg leading-[1.9] md:leading-[1.9] lg:leading-[1.9] max-w-5xl mx-auto mb-8 md:mb-12 text-gray-600'>Designed to provide you with a simple and intuitive set of UI components that are easy to use, customize and integrate into your React application. We have carefully crafted each component to ensure that they are responsive, accessible and consistent across different devices and browsers.</Text>
